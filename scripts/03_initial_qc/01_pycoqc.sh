...
pycoQC \
--summary_file $seq_reports_dir/sequencing_summary_FAQ91555_ab35bd75.txt \
--html_outfile $project_dir/results/03_initial_qc/pycoqc/pycoqc_initial_basecalling_ab35bd75.html

pycoQC \
--summary_file $seq_reports_dir/sequencing_summary_FAQ91555_05abd159.txt \
--html_outfile $project_dir/results/03_initial_qc/pycoqc/pycoqc_initial_basecalling_05abd159.html
